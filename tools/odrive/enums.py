...
MOTOR_ERROR_TIMER_UPDATE_MISSED          = 0x00020000
MOTOR_ERROR_CURRENT_MEASUREMENT_UNAVAILABLE = 0x00040000
MOTOR_ERROR_CONTROLLER_FAILED            = 0x00080000
MOTOR_ERROR_I_BUS_OUT_OF_RANGE           = 0x00100000
MOTOR_ERROR_BRAKE_RESISTOR_DISARMED      = 0x00200000
MOTOR_ERROR_SYSTEM_LEVEL                 = 0x00400000
MOTOR_ERROR_BAD_TIMING                   = 0x00800000
MOTOR_ERROR_UNKNOWN_PHASE_ESTIMATE       = 0x01000000
MOTOR_ERROR_UNKNOWN_PHASE_VEL            = 0x02000000
MOTOR_ERROR_UNKNOWN_TORQUE               = 0x04000000
MOTOR_ERROR_UNKNOWN_CURRENT_COMMAND      = 0x08000000
MOTOR_ERROR_UNKNOWN_CURRENT_MEASUREMENT  = 0x10000000
MOTOR_ERROR_UNKNOWN_VBUS_VOLTAGE         = 0x20000000
MOTOR_ERROR_UNKNOWN_VOLTAGE_COMMAND      = 0x40000000
MOTOR_ERROR_UNKNOWN_GAINS                = 0x80000000
MOTOR_ERROR_CONTROLLER_INITIALIZING      = 0x100000000
